<h1 align = "center">Spread-LaTeX</h1>
<p align = "center"> Latest update (October 10, 2019) </p>

The add-on is for converting a Google spreadsheet table to a LaTeX table or a LaTeX table to a Google Spreadsheet table.<p>
